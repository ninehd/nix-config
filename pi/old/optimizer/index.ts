/**
 * optimizer — token-optimization suite for Pi Coding Agent.
 *
 ...
 * off, accented when on) and ONE command (/optimizer — an interactive
 * overlay). index.ts wires lifecycle hooks via each module, then registers
 * the overlay command.
 */
