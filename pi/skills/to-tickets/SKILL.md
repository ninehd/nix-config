...
Publish the approved tickets. **How** depends on the tracker configuration from `setup-matt-pocock-skills` — the tickets are the same either way, only the shape of the blocking edges changes:
